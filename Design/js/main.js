...
$('#contact_send').click(function()
{
    ...
    {
        $('#contact_status_message').html("<div class = 'alert alert-danger'>المرجو ملأ الخانات!<div>");
    }
    else
    {
        if(!ValidateEmail(contact_email))
        {
            $('#contact_status_message').html("<div class = 'alert alert-danger'>  البريد الكتروني غير صالح!<div>");
        }
        else
        {
            $.ajax({
