		...
		<form method="post" id="appointment_form" action="appointment.php">
			...
			<div class="select_services_div tab_reservation" id="services_tab">
				...
				<div class="alert alert-danger" role="alert" style="display: none">
					المرجو اختيار خدمة واحدة على الأقل!
				</div>

				<div class="text_header" style="text-align:right;">
					<span >
						1. اختيار الخدمة
					</span>
				</div>
                                    	...
                                    	<div class="select_item_bttn">
                                    		<div class="btn-group-toggle" data-toggle="buttons">
												<label class="service_label item_label btn btn-secondary">
													<input type="checkbox"  name="selected_services[]" value="<?php echo $row['service_id'] ?>" autocomplete="off">اختيار
												</label>
											</div>
                                    	</div>
                                    <?php
                                    ...
                                    ?>
                                    		<div class="select_item_bttn">
                                    			<label class="item_label btn btn-secondary active">
													<input type="radio" class="radio_employee_select" name="selected_employee" value="<?php echo $row['employee_id'] ?>">اختيار
												</label>	
                                    		</div>
                                    <?php
                                		echo "</div>";
			...
			<div class="select_date_time_div tab_reservation" id="calendar_tab">
		        ...
		        <div class="alert alert-danger" role="alert" style="display: none">
		          المرجو اختيار اليوم و الساعة!
		        </div>

				<div class="text_header">
					<span>
						3. اختيار اليوم و الساعة
					</span>
				</div>
			...
			<div style="overflow:auto;padding: 30px 0px;">
    			<div style="">
    				<input type="hidden" name="submit_book_appointment_form">
      				<button type="button" id="prevBtn"  class="next_prev_buttons" style="background-color: #bbbbbb;"  onclick="nextPrev(-1)">السابق</button>
      				<button type="button" id="nextBtn" class="next_prev_buttons" onclick="nextPrev(1)">التالي</button>
    			</div>
  			</div>
